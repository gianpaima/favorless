...
class FormRegistrarUsuario(forms.Form):
	registro_input_nombre_completo = forms.CharField(max_length=20,widget=forms.TextInput(attrs={'class':'form-control','id':'r_input_nombre_completo','placeholder':'Nombre Completo'}))
	...
	registro_input_password = forms.CharField(widget= forms.PasswordInput(attrs={'class':'form-control','id':'r_input_password','placeholder':'Contrasena'}))
